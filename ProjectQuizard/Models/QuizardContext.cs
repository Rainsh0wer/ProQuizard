...
public partial class QuizardContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Classroo__CB1927A0DAE0AB16");
        ...
        {
            entity.HasKey(e => e.EnrollmentId).HasName("PK__Enrollme__7F6877FB21F3E5A4");

            entity.ToTable("Enrollment");

            entity.HasIndex(e => new { e.ClassId, e.StudentId }, "UQ__Enrollme__483575069E21D87C").IsUnique();
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF6781E4466");
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__Question__0DC06F8C4637B954");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Questions)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("QuestionId", "TagId").HasName("PK__Question__DB97A028B1731CCA");
        ...
        {
            entity.HasKey(e => e.OptionId).HasName("PK__Question__92C7A1DF05E0FE75");
        ...
        {
            entity.HasKey(e => e.QuizId).HasName("PK__Quiz__8B42AE6EA84ECDCF");
        ...
        {
            entity.HasKey(e => e.AssignmentId).HasName("PK__QuizAssi__32499E571EA5F34E");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__QuizLike__A2922CF40CD76022");

            entity.ToTable("QuizLike");

            entity.HasIndex(e => new { e.UserId, e.QuizId }, "UQ__QuizLike__EF3CE64BDD579178").IsUnique();
        ...
        {
            entity.HasKey(e => e.SavedId).HasName("PK__SavedQui__0B058FFCA6C62FAE");

            entity.ToTable("SavedQuiz");

            entity.HasIndex(e => new { e.StudentId, e.QuizId }, "UQ__SavedQui__CA71009EFDE4F997").IsUnique();
        ...
        {
            entity.HasKey(e => e.AnswerId).HasName("PK__StudentA__D4825024C7E148B3");
        ...
        {
            entity.HasKey(e => e.StudentQuizId).HasName("PK__StudentQ__0C414D8AF983F7B6");
        ...
        {
            entity.HasKey(e => e.SubjectId).HasName("PK__Subject__AC1BA388A47F8CAC");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tag__657CFA4C1D3A6626");

            entity.ToTable("Tag");

            entity.HasIndex(e => e.Name, "UQ__Tag__737584F6FB4EAAFB").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACEBF73AB1");

            entity.ToTable("User");

            entity.HasIndex(e => e.Username, "UQ__User__536C85E482E516DF").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__User__A9D105348E3ED11A").IsUnique();
